...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxc10772a5d5a7d7b0',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'c6ed4d7c4de0b2a7aad01c6f6aa96c26',
  ...
  USERS: [
    {
      ...
      id: 'o0gR_5_oOpLhHfRsTcshiuePkfzc',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '',
      // 所在省份
      province: '重庆',
  ...
  CALLBACK_TEMPLATE_ID: 'viWwFJCB91rmAzpk25eX_N23YcixIGhNYQ1LWUy7-tU',
